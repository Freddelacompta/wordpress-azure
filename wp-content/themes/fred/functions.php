...
add_image_size( 'bones-thumb-400', 400, 270, true );
...
function bones_custom_image_sizes( $sizes ) {
    return array_merge( $sizes, array(
        ...
        'bones-thumb-400' => __('400px by 270px'),
    ) );
}
...
// In the backoffice, replace checkbox by radio button to select category of a post, in order to limit the number of selection to only one.
